...
export const GET: APIRoute = async ({ params }) => {
    ...
    let panelServices = records.filter(obj => obj.panelSlug === id?.toString());
    let panelServices1 = records1.filter(obj => obj.panelSlug === id?.toString());
    let panelServices2 = records2.filter(obj => obj.panelSlug === id?.toString());
    let panelServices3 = records3.filter(obj => obj.panelSlug === id?.toString());
    let panelServices4 = records4.filter(obj => obj.panelSlug === id?.toString());
    let panelServices5 = records5.filter(obj => obj.panelSlug === id?.toString());
